            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className={`p-4 rounded-lg border ${
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className={`text-sm ${
                    membresia.saldo > 0 ? 'text-red-700' : 'text-green-700'
                  }`}>
                    Saldo Pendiente
                  </p>
                </div>
              ...
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div className="flex gap-3">
                  ...
                  <div className="text-sm text-yellow-800">
                    <p className="font-semibold mb-1">Pago Pendiente</p>
                    <p>
                      Esta membresía tiene un saldo pendiente de ${membresia.saldo.toLocaleString('es-AR', { minimumFractionDigits: 2 })}.
                      El socio debe completar el pago para mantener la membresía activa.
                    </p>
                  </div>
                </div>
              </div>
